...
var actions = map[int32]struct {
	...
	^xkF1:  {doWorkspaceMigrate, 0},
	^xkF2:  {doWorkspaceMigrate, 1},
	^xkF3:  {doWorkspaceMigrate, 2},
	^xkF4:  {doWorkspaceMigrate, 3},
	^xkF5:  {doWorkspaceMigrate, 4},
	^xkF6:  {doWorkspaceMigrate, 5},
	^xkF7:  {doWorkspaceMigrate, 6},
	^xkF8:  {doWorkspaceMigrate, 7},
	^xkF9:  {doWorkspaceMigrate, 8},
	^xkF10: {doWorkspaceMigrate, 9},
	^xkF11: {doWorkspaceMigrate, 10},
	^xkF12: {doWorkspaceMigrate, 11},
